...
// contoh gambar (ganti sesuai asset kamu)
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-800">Promo Spesial ✨</h2>

          <p className="text-gray-500 mt-3">
            Spesial buat kamu yang lagi scroll, yuk ambil promonya sekarang
            juga!
          </p>
        </motion.div>
